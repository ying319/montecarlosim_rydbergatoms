# -*- coding: utf-8 -*-
"""
Created on Thu Nov  7 11:36:20 2019
...
def calculate_spectrum(states, transitionRates, n1,l1,j1, atom_type = 'Rb87', iters = 300000, 
    ...
    for n in range(10,30,1):
        for n1 in range(10,30,1): 
            ...
            #print(atom.getTransitionWavelength(n,2,5/2, n1,1,3/2))
                        ...
                        print('thz fre', thz)
                        dm_ryd = abs(atom.getDipoleMatrixElement(6, 0, 0.5, 0.5, n,1,j1, 0.5, 0))
